						...
						<form class="form-horizontal" method="post" action="<?php echo base_url() . 'manage_student/create_student'; ?>">
						  <fieldset>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="student_father_name" value="<?php echo set_value('student_father_name'); ?>">
								
                                <?php echo form_error('student_father_name'); ?>
							  </div>
							</div>
                            <div class="control-group">
							  <label class="control-label" for="typeahead">Mother Name </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="student_mother_name" value="<?php echo set_value('student_mother_name'); ?>">
                                  <?php echo form_error('student_mother_name'); ?>
							  </div>
							</div>
                            <div class="control-group">
							  <label class="control-label" for="typeahead">Unique Code </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="student_unique_code" value="<?php echo set_value('student_unique_code'); ?>">
                                                <?php echo form_error('student_unique_code'); ?>
							  </div>
							</div>
                            ...
                            <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError3" class="span6 typeahead" name="student_academic_year">
									<?php
                                                    for ($year = date("Y"); $year >= 2014; $year--) {
                                                        $slct = (set_value('student_academic_year') == $year) ? 'selected' : '';
                                                        ?>
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="student_class_position" value="<?php echo set_value('student_class_position'); ?>">
                                                <?php echo form_error('student_class_position'); ?>
							  </div>
							</div>
                            <div class="control-group">
							  <label class="control-label" for="typeahead">Address </label>
							  <div class="controls">
								<textarea id="message" required class="form-control span6" name="student_address" value="<?php echo set_value('student_class_position'); ?>" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10"></textarea>
